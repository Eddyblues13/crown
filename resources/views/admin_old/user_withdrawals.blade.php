@include('admin.header')
    ...
    <div class="container py-4">
      <h6 class="mb-4 fs-5"><small><a href="#" class="text-decoration-none">Control Panel</a> <a href="{{route('manage.users.page')}}" class="text-decoration-none">Users</a> > <a href="userProfile.html" class="text-decoration-none">{{ $user_name }}.</a> > Withdrawals</small></h6>
        <div class="mb-3">
          Balance: ${{number_format($balance_sum, 2, '.', ',')}}
        </div>
